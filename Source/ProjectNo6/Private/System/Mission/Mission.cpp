...
#include "System/Mission/Mission.h"
...
UGameInstance* UMission::CustomGetGameInstance()
{
	return (GetWorld() != nullptr ? GetWorld()->GetGameInstance() : nullptr);
}

void UMission::CustomPlaySound2D(USoundBase* Sound, float VolumeMultiplier /*= 1.f*/, float PitchMultiplier /*= 1.f*/, float StartTime /*= 0.f*/, USoundConcurrency* ConcurrencySettings /*= nullptr*/, const AActor* OwningActor /*= nullptr*/, bool bIsUISound /*= true*/)
{
...
APlayerController* UMission::CustomGetPlayerController()
{
